...
class UsersPage(BasePage):
    ...
    def get_search_response_for_new_user(self, username):
        return self.api_requests.get_search_response(f"https://test.isi-technology.com:8000/api/v1/accounts"
                                                     f"/profile_table/?limit=20&offset=0&search={username}&search_type=user")
